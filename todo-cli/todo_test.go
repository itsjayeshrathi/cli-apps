...
func TestDelete(t *testing.T) {
	...
	if l[0].Task != tasks[0] {
		t.Errorf("Expected %q, but instead got %q", tasks[0], l[0].Task)
	}
	l.Delete(2)
	if l[1].Task != tasks[2] {
		t.Errorf("Expected %q, but instead got %q", tasks[2], l[1].Task)
	}
}
...
func TestSaveGet(t *testing.T) {
	...
	if l1[0].Task != taskName {
		t.Errorf("Expected %q, but instead got %q", taskName, l1[0].Task)
	}
